    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          <TextInput
            multiline={true}
            style={[styles.newDownItem]}
            onSubmitEditing={handleSubmit}
            placeholder="get it down..."
            enablesReturnKeyAutomatically
            blurOnSubmit
            autoFocus
            value={newDownItem}
            onChangeText={updateNewDownItem}
          ></TextInput>
        </Animated.View>
      </ScrollView>
      ...
      <TouchableOpacity
        ...
        style={styles.showDownItems}
        onPress={() => navigate(Routes.display)}
      >
        <Text style={styles.showDownItemsText}>Show My Items</Text>
      </TouchableOpacity>
    </View>
  );
}
